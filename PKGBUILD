...
source=(
  ...
  'downstream-1.18.16.patch'
  'opencode-daemon'
  'opencode-daemon.service'
  'LICENSE'
)
b2sums=('SKIP'
        'ebce534e19ed550af7e186de7c7e7d255125116f9b0b9cd2c80b44760c5238aaf1052cc527b096e12d868ae564468eed6203c079a803f4cd50c64c3c5bc3f2b5'
...
prepare() {
  cd $pkgbase
  patch -Np1 -i ../downstream-1.18.16.patch
